...
import (
	...
	"github.com/fearblackcat/grpc-demo/api"
    "github.com/fearblackcat/grpc-demo/pkg/ui/data/swagger"
...
func startRESTServer(address, grpcAddress, certFile string) error {
    ...
    smux.HandleFunc("/swagger.json", func(w http.ResponseWriter, req *http.Request) {
	...
	http.ListenAndServe(address, smux)
